...
/**
 * Determines if one value is greater than or equal to the other value.
 *
 * @constructor Creates a GreaterThanEqualOperation that determines if the left
 *      value is greater than or equal to the right value.
 */
class GreaterThanEqualOperation(leftValue: NumericValue?, rightValue: NumericValue?)
    : NumericEqualityOperation(leftValue, rightValue)
{
     ...
     *
     * @return A BooleanValue holding true if the left value is greater than or
     *      equal to the right value, or false if the left value is strictly less
    ...
    companion object CREATOR : Parcelable.Creator<GreaterThanEqualOperation>
    {
        private val TAG: String = GreaterThanEqualOperation::class.java.simpleName

        override fun createFromParcel(parcel: Parcel): GreaterThanEqualOperation
        {
            return GreaterThanEqualOperation(parcel)
        }

        override fun newArray(size: Int): Array<GreaterThanEqualOperation?>
        {
